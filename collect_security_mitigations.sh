...
#
# Usage:
#   sudo ./collect_security_mitigations.sh [--compact]
#   ./collect_security_mitigations.sh --help
#   ./collect_security_mitigations.sh --version
#
# Output:
...
app_name="collect_security_mitigations"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_security_mitigations.sh - collect security-mitigation states and performance-relevant mitigation policy evidence

Usage:
  ./collect_security_mitigations.sh [--compact|--summary|--view]
  ./collect_security_mitigations.sh --help
  ./collect_security_mitigations.sh --version
