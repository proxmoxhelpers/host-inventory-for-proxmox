...
#
# Usage:
#   sudo ./view_acpi_platform.sh
#   ./view_acpi_platform.sh --file collect_acpi_platform.json
#   ./view_acpi_platform.sh --help
#
# Output:
...
usage() {
    cat <<'EOF'
view_acpi_platform.sh - standalone ACPI / platform architecture view

Usage:
  sudo ./view_acpi_platform.sh
  ./view_acpi_platform.sh --file collect_acpi_platform.json
  sudo ./view_acpi_platform.sh --json > collect_acpi_platform.json
