...
#
# Usage:
#   sudo ./collect_proxmox_host.sh [--compact]
#   ./collect_proxmox_host.sh --help
#   ./collect_proxmox_host.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_proxmox_host.sh - collect Proxmox node, cluster, storage and VM configuration state
Usage: ./collect_proxmox_host.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
