...
#
# Usage:
#   sudo ./view_timers_watchdogs.sh
#   ./view_timers_watchdogs.sh --file collect_timers_watchdogs.json
#   ./view_timers_watchdogs.sh --help
#
# Output:
...
app_name="view_timers_watchdogs"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
view_timers_watchdogs.sh - standalone timers / watchdogs view

Usage:
  sudo ./view_timers_watchdogs.sh
  ./view_timers_watchdogs.sh --file collect_timers_watchdogs.json
  sudo ./view_timers_watchdogs.sh --json > collect_timers_watchdogs.json
