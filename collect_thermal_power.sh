...
#
# Usage:
#   sudo ./collect_thermal_power.sh [--compact]
#   ./collect_thermal_power.sh --help
#   ./collect_thermal_power.sh --version
#
# Output:
...
app_name="collect_thermal_power"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_thermal_power.sh - collect thermal sensors, hwmon, power limits and turbostat snapshot
Usage: ./collect_thermal_power.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
