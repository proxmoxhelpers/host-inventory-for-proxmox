...
#
# Usage:
#   sudo ./collect_storage.sh [--compact]
#   ./collect_storage.sh --help
#   ./collect_storage.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_storage.sh - collect block queues, NVMe, LVM/ZFS and Proxmox storage state
Usage: ./collect_storage.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
