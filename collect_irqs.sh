...
#
# Usage:
#   sudo ./collect_irqs.sh [--compact]
#   ./collect_irqs.sh --help
#   ./collect_irqs.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_irqs.sh - collect IRQ affinity, interrupt counters and irqbalance state
Usage: ./collect_irqs.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
