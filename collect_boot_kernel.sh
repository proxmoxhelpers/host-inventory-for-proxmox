...
#
# Usage:
#   sudo ./collect_boot_kernel.sh [--compact]
#   ./collect_boot_kernel.sh --help
#   ./collect_boot_kernel.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_boot_kernel.sh - collect boot, kernel-command-line and kernel capability state
Usage: ./collect_boot_kernel.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
