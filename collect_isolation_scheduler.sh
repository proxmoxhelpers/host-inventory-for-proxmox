...
#
# Usage:
#   sudo ./collect_isolation_scheduler.sh [--compact]
#   ./collect_isolation_scheduler.sh --help
#   ./collect_isolation_scheduler.sh --version
#
# Output:
...
app_name="collect_isolation_scheduler"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_isolation_scheduler.sh - collect CPU isolation, workqueue, cgroup and scheduler state
Usage: ./collect_isolation_scheduler.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
