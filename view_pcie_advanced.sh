...
#
# Usage:
#   sudo ./view_pcie_advanced.sh
#   ./view_pcie_advanced.sh --file collect_pcie_advanced.json
#   ./view_pcie_advanced.sh --help
#
# Output:
...
usage() {
    cat <<'EOF'
view_pcie_advanced.sh - standalone advanced PCIe view

Usage:
  sudo ./view_pcie_advanced.sh
  ./view_pcie_advanced.sh --file collect_pcie_advanced.json
  sudo ./view_pcie_advanced.sh --json > collect_pcie_advanced.json
