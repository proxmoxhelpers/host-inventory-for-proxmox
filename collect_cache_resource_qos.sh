...
#
# Usage:
#   sudo ./collect_cache_resource_qos.sh [--compact]
#   ./collect_cache_resource_qos.sh --help
#   ./collect_cache_resource_qos.sh --version
#
# Output:
...
app_name="collect_cache_resource_qos"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_cache_resource_qos.sh - collect cache topology, NUMA/fabric distance and resctrl resource-control capabilities

Usage:
  ./collect_cache_resource_qos.sh [--compact|--summary|--view]
  ./collect_cache_resource_qos.sh --help
  ./collect_cache_resource_qos.sh --version
