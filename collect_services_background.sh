...
#
# Usage:
#   sudo ./collect_services_background.sh [--compact]
#   ./collect_services_background.sh --help
#   ./collect_services_background.sh --version
#
# Output:
...
app_name="collect_services_background"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_services_background.sh - collect services, timers and scheduled Proxmox work
Usage: ./collect_services_background.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
