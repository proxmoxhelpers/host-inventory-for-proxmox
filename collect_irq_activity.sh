...
#
# Usage:
#   sudo ./collect_irq_activity.sh [--compact]
#   ./collect_irq_activity.sh --help
#   ./collect_irq_activity.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_irq_activity.sh - collect passive IRQ and softirq activity deltas

Usage:
  ./collect_irq_activity.sh [--compact|--summary|--view]
  ./collect_irq_activity.sh --help
  ./collect_irq_activity.sh --version
