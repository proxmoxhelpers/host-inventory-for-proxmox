...
#
# Usage:
#   sudo ./collect_cpu_topology.sh [--compact]
#   ./collect_cpu_topology.sh --help
#   ./collect_cpu_topology.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_cpu_topology.sh - collect CPU/core/SMT/cache/NUMA topology
Usage: ./collect_cpu_topology.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
