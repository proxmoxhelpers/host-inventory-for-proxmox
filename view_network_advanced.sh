...
#
# Usage:
#   sudo ./view_network_advanced.sh
#   ./view_network_advanced.sh --file collect_network_advanced.json
#   ./view_network_advanced.sh --help
#
# Output:
...
app_name="view_network_advanced"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
view_network_advanced.sh - standalone advanced network view

Usage:
  sudo ./view_network_advanced.sh
  ./view_network_advanced.sh --file collect_network_advanced.json
  sudo ./view_network_advanced.sh --json > collect_network_advanced.json
