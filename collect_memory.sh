...
#
# Usage:
#   sudo ./collect_memory.sh [--compact]
#   ./collect_memory.sh --help
#   ./collect_memory.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_memory.sh - collect RAM, NUMA, HugeTLB, THP, KSM and swap state
Usage: ./collect_memory.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
