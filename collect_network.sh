...
#
# Usage:
#   sudo ./collect_network.sh [--compact]
#   ./collect_network.sh --help
#   ./collect_network.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_network.sh - collect NIC, bridge, queue, offload and coalescing state
Usage: ./collect_network.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
