...
#
# Usage:
#   sudo ./collect_storage_health_power.sh [--compact]
#   ./collect_storage_health_power.sh --help
#   ./collect_storage_health_power.sh --version
#
# Output:
...
app_name="collect_storage_health_power"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_storage_health_power.sh - collect storage health, power-state and advanced queue evidence

Usage:
  ./collect_storage_health_power.sh [--compact|--summary|--view]
  ./collect_storage_health_power.sh --help
  ./collect_storage_health_power.sh --version
