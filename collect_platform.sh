...
#
# Usage:
#   sudo ./collect_platform.sh [--compact]
#   ./collect_platform.sh --help
#   ./collect_platform.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_platform.sh - collect Proxmox/OS/firmware platform identity

Usage:
  ./collect_platform.sh [--compact|--summary|--view]
  ./collect_platform.sh --help
  ./collect_platform.sh --version

The collector is read-only. Root is helpful for some firmware tools but is
not required; unavailable data is reported as null/unavailable.
EOF
    inv_print_common_usage
    return 0
}
...
# ============================================================
# main
# Dispatches help/version/collection after common option parsing.
#
# Version:
#   1.0.0
#
