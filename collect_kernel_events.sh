...
#
# Usage:
#   sudo ./collect_kernel_events.sh [--compact]
#   ./collect_kernel_events.sh --help
#   ./collect_kernel_events.sh --version
#
# Output:
...
app_name="collect_kernel_events"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_kernel_events.sh - collect kernel-event / reliability history

Usage:
  ./collect_kernel_events.sh [--compact|--summary|--view]
  ./collect_kernel_events.sh --help
  ./collect_kernel_events.sh --version
