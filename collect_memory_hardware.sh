...
#
# Usage:
#   sudo ./collect_memory_hardware.sh [--compact]
#   ./collect_memory_hardware.sh --help
#   ./collect_memory_hardware.sh --version
#
# Output:
...
app_name="collect_memory_hardware"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_memory_hardware.sh - collect memory module, SPD and EDAC hardware evidence

Usage:
  ./collect_memory_hardware.sh [--compact|--summary|--view]
  ./collect_memory_hardware.sh --help
  ./collect_memory_hardware.sh --version
