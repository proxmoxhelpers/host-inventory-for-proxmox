...
#
# Usage:
#   sudo ./collect_usb_input_audio.sh [--compact]
#   ./collect_usb_input_audio.sh --help
#   ./collect_usb_input_audio.sh --version
#
# Output:
...
app_name="collect_usb_input_audio"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_usb_input_audio.sh - collect USB, HID/input and audio topology evidence

Usage:
  ./collect_usb_input_audio.sh [--compact|--summary|--view]
  ./collect_usb_input_audio.sh --help
  ./collect_usb_input_audio.sh --version
