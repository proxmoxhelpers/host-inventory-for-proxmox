...
#
# Usage:
#   sudo ./collect_cpu_power_idle.sh [--compact]
#   ./collect_cpu_power_idle.sh --help
#   ./collect_cpu_power_idle.sh --version
#
# Output:
...
app_name="collect_cpu_power_idle"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_cpu_power_idle.sh - collect CPU frequency, governor, EPP and idle-state data
Usage: ./collect_cpu_power_idle.sh [--compact|--help|--version]
EOF
    inv_print_common_usage
    return 0
}
