...
#
# Usage:
#   sudo ./collect_runtime_pressure.sh [--compact]
#   ./collect_runtime_pressure.sh --help
#   ./collect_runtime_pressure.sh --version
#
# Output:
...
app_name="collect_runtime_pressure"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_runtime_pressure.sh - collect passive scheduler, PSI and VM pressure activity

Usage:
  ./collect_runtime_pressure.sh [--compact|--summary|--view]
  ./collect_runtime_pressure.sh --help
  ./collect_runtime_pressure.sh --version
