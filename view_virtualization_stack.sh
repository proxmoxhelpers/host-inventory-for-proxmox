...
# Standalone colorized view of KVM/QEMU/vhost/VFIO virtualization-stack evidence.
#
# Version:
#   0.9.2
#
# Usage:
#   sudo ./view_virtualization_stack.sh
#   ./view_virtualization_stack.sh --file collect_virtualization_stack.json
#   ./view_virtualization_stack.sh --help
#
# Output:
...
app_name="view_virtualization_stack"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
view_virtualization_stack.sh - standalone KVM/QEMU/vhost/VFIO virtualization-stack view

Usage:
  sudo ./view_virtualization_stack.sh
  ./view_virtualization_stack.sh --file collect_virtualization_stack.json
  ./view_virtualization_stack.sh --json > collect_virtualization_stack.json
  ./view_virtualization_stack.sh --help
  ./view_virtualization_stack.sh --version
EOF
    inv_print_common_usage
    return 0
}
