...
#
# Usage:
#   sudo ./collect_memory_fragmentation.sh [--compact]
#   ./collect_memory_fragmentation.sh --help
#   ./collect_memory_fragmentation.sh --version
#
# Output:
...
app_name="collect_memory_fragmentation"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_memory_fragmentation.sh - collect memory fragmentation, compaction and hugepage-feasibility evidence

Usage:
  ./collect_memory_fragmentation.sh [--compact|--summary|--view]
  ./collect_memory_fragmentation.sh --help
  ./collect_memory_fragmentation.sh --version
