...
#
# Usage:
#   sudo ./collect_display_timing.sh [--compact]
#   ./collect_display_timing.sh --help
#   ./collect_display_timing.sh --version
#
# Output:
...
app_name="collect_display_timing"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_display_timing.sh - collect host-visible display connector, EDID, mode and variable-refresh evidence

Usage:
  ./collect_display_timing.sh [--compact|--summary|--view]
  ./collect_display_timing.sh --help
  ./collect_display_timing.sh --version
