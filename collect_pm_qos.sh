...
#
# Usage:
#   sudo ./collect_pm_qos.sh [--compact]
#   ./collect_pm_qos.sh --help
#   ./collect_pm_qos.sh --version
#
# Output:
...
usage() {
    cat <<'EOF'
collect_pm_qos.sh - collect PM-QoS and runtime-power latency evidence

Usage:
  ./collect_pm_qos.sh [--compact|--summary|--view]
  ./collect_pm_qos.sh --help
  ./collect_pm_qos.sh --version
