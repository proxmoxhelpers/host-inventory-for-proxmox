...
#
# Usage:
#   sudo ./collect_cpu_limits_pmu.sh [--compact]
#   ./collect_cpu_limits_pmu.sh --help
#   ./collect_cpu_limits_pmu.sh --version
#
# Output:
...
app_name="collect_cpu_limits_pmu"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_cpu_limits_pmu.sh - collect CPU performance-limit, thermal-throttle and PMU capability evidence

Usage:
  ./collect_cpu_limits_pmu.sh [--compact|--summary|--view]
  ./collect_cpu_limits_pmu.sh --help
  ./collect_cpu_limits_pmu.sh --version
