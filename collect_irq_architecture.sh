...
#
# Usage:
#   sudo ./collect_irq_architecture.sh [--compact]
#   ./collect_irq_architecture.sh --help
#   ./collect_irq_architecture.sh --version
#
# Output:
...
app_name="collect_irq_architecture"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_irq_architecture.sh - collect IRQ hardware identifiers, irqchip/domain evidence and special interrupt/IPI topology

Usage:
  ./collect_irq_architecture.sh [--compact|--summary|--view]
  ./collect_irq_architecture.sh --help
  ./collect_irq_architecture.sh --version
