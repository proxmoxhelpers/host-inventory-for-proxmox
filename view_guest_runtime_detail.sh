...
#
# Usage:
#   sudo ./view_guest_runtime_detail.sh
#   ./view_guest_runtime_detail.sh --file collect_runtime_pressure.json
#   ./view_guest_runtime_detail.sh --help
#
# Output:
...
app_name="view_guest_runtime_detail"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
view_guest_runtime_detail.sh - standalone guest runtime scheduler / memory detail view

Usage:
  sudo ./view_guest_runtime_detail.sh
  ./view_guest_runtime_detail.sh --file collect_guest_runtime_detail.json
  sudo ./view_guest_runtime_detail.sh --json > collect_guest_runtime_detail.json
