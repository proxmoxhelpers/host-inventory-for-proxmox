...
# ============================================================
# measure_osnoise.sh
# Runs a bounded rtla osnoise measurement.
#
# Version:
#   0.9.2
#
...
usage() {
    cat <<'EOF'
measure_osnoise.sh - measure host OS noise with rtla

Usage:
  ./measure_osnoise.sh [options]
...
main() {
    set -- rtla osnoise top -d "${app_duration}s"
