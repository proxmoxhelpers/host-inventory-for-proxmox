...
#
# Usage:
#   sudo ./collect_latency_sample.sh [--compact]
#   ./collect_latency_sample.sh --help
#   ./collect_latency_sample.sh --version
#
# Output:
...
app_name="collect_latency_sample"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_latency_sample.sh - collect a bounded passive latency/pressure sample

Usage:
  ./collect_latency_sample.sh [--compact|--summary|--view]
  ./collect_latency_sample.sh --help
  ./collect_latency_sample.sh --version
