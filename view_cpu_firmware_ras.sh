...
#
# Usage:
#   sudo ./view_cpu_firmware_ras.sh
#   ./view_cpu_firmware_ras.sh --file collect_cpu_firmware_ras.json
#   ./view_cpu_firmware_ras.sh --help
#
# Output:
...
app_name="view_cpu_firmware_ras"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
view_cpu_firmware_ras.sh - standalone CPU microcode / RAS view

Usage:
  sudo ./view_cpu_firmware_ras.sh
  ./view_cpu_firmware_ras.sh --file collect_cpu_firmware_ras.json
  sudo ./view_cpu_firmware_ras.sh --json > collect_cpu_firmware_ras.json
