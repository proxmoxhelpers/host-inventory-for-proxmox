...
#
# Usage:
#   sudo ./view_firmware_settings.sh
#   ./view_firmware_settings.sh --file collect_firmware_settings.json
#   ./view_firmware_settings.sh --help
#
# Output:
...
app_name="view_firmware_settings"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
view_firmware_settings.sh - standalone firmware / BIOS settings view

Usage:
  sudo ./view_firmware_settings.sh
  ./view_firmware_settings.sh --file collect_firmware_settings.json
  sudo ./view_firmware_settings.sh --json > collect_firmware_settings.json
