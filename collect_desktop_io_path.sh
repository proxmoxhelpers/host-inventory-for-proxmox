...
#
# Usage:
#   sudo ./collect_desktop_io_path.sh [--compact]
#   ./collect_desktop_io_path.sh --help
#   ./collect_desktop_io_path.sh --version
#
# Output:
...
app_name="collect_desktop_io_path"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_desktop_io_path.sh - collect host-side interactive desktop I/O-path evidence

Usage:
  ./collect_desktop_io_path.sh [--compact|--summary|--view]
  ./collect_desktop_io_path.sh --help
  ./collect_desktop_io_path.sh --version
