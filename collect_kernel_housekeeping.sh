...
#
# Usage:
#   sudo ./collect_kernel_housekeeping.sh [--compact]
#   ./collect_kernel_housekeeping.sh --help
#   ./collect_kernel_housekeeping.sh --version
#
# Output:
...
app_name="collect_kernel_housekeeping"
app_version=0.9.2
app_rc=0
app_compact=0
...
usage() {
    cat <<'EOF'
collect_kernel_housekeeping.sh - collect kernel housekeeping and IPI placement evidence

Usage:
  ./collect_kernel_housekeeping.sh [--compact|--summary|--view]
  ./collect_kernel_housekeeping.sh --help
  ./collect_kernel_housekeeping.sh --version
